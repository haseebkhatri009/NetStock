...
//   const [sortBy, setSortBy] = useState('date-desc') // date-desc, date-asc, items-desc, items-asc
...
//     if (search) {
//       result = challans.filter((challan) => {
//         // Search by DC number
//         if (
//           challan.dcNumber &&
//           challan.dcNumber.toLowerCase().includes(search)
...
//               : ''
//           }`
//         : challan.customerName || challan.customerCompany || ''
//     )
...
//               className="input text-sm py-2 pr-8 min-w-[180px]"
//             >
...
//                     // Determine display name: if customerName exists, show it bold with company below
//                     // else show company as bold (name style)
//                     const hasName = !!c.customerName
//                     const hasCompany = !!c.customerCompany
...
//                           {/* If no name but company exists, show company bold (same style as name) */}
//                           {!hasName && hasCompany && (
//                             <p className="font-medium text-ink">
//                               {c.customerCompany}
//                             </p>
...
//                                       {/* Show name bold if exists, else company bold */}
//                                       {customer.name ? (
//                                         <>
//                                           <div className="font-medium text-sm text-ink truncate">
//                                             {customer.name}
...
//   // Determine what to show in "Delivery To" section
//   // Priority: Company > Name > Nothing
//   const deliveryToName = customerCompany || customerName || ''
...
//                 {/* Show company name first with M/S. prefix if exists */}
//                 {customerCompany && (
//                   <div
//                     className="dc-delivery-to-name"
//                     style={{
...
//     // Duplicate check removed — user can create multiple DCs with same number
//     setDcNumberError('')
//     return true
//   }
...
//       if (!editingChallan) {
//         // Only increment counter when the DC number matches the auto-generated format
//         // and hasn't been manually changed to a duplicate
//         await incrementDcCounter(
//           companyId
//         )
...
/* ============================================================
   ...
   ============================================================
   Ye sirf fallback hain — agar kisi company ne apna logo,
   address, ya email set nahi kiya to ye use honge.
   ============================================================ */
    ...
    try {
      ...
      if (editingChallan) {
        ...
        const allUpdates = {
          ...
          [`companies/${companyId}/challans/${editingChallan.id}/companyLogo`]:
            companyLogo,

          [`companies/${companyId}/challans/${editingChallan.id}/companyAddress`]:
            companyAddress,

          [`companies/${companyId}/challans/${editingChallan.id}/companyEmail`]:
            companyEmail,

          [`companies/${companyId}/challans/${editingChallan.id}/companyPhone`]:
            companyPhone,
...
export function PrintableModal({
  ...
  /* ============================================================
     LIVE COMPANY DATA
     ============================================================
     PrintableModal now reads the live company object from
     AuthContext, so even if a challan's saved snapshot is
     missing companyLogo / companyAddress / etc., we can
     still fall back to the CURRENT company data.
     ============================================================ */
...
`)
  ...
  /* ============================================================
     ...
     ============================================================
     Priority:
       1. doc.companyLogo / companyName / etc. (saved snapshot)
       2. Live company from AuthContext
       3. Hard fallback constants

     This ensures:
       - New challans use saved snapshot
       - Old challans (before this feature) use live company data
       - If company has no logo yet, only then fallback
     ============================================================ */
