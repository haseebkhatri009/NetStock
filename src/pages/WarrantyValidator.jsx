...
import { useState } from 'react'
import { ref, get } from 'firebase/database'
import { ShieldCheck, ShieldAlert, ShieldX, Search, ChevronDown, ChevronUp, Package } from 'lucide-react'
import { db } from '../firebase'
import { useAuth } from '../context/AuthContext'
import { formatDate, normalizeMac, addMonths, WARRANTY_MONTHS } from '../utils/helpers'
  ...
  return (
    <div className="max-w-3xl">
      ...
      {results.map((result) => {
        ...
        const isExpanded = expanded === result.id
        const soldToDisplay = formatSoldTo(result)
        const imageUrl = getProductImage(result.name)
                    ...
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        if (parent) {
                          ...
                          fallback.className = 'h-10 w-10 rounded-xl flex items-center justify-center bg-teal-light text-teal-dark'
